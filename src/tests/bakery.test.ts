import {div, echo, getRandomNumber, reverseArray} from "../utils/tools";
import {isCategoryExists} from "../firebase/firebaseDBService.ts";
...
describe('BakeryShop.tools', ()=> {
   let arr:number[]
    ...
    test('async function echo', ()=> expect(echo('Hello')).resolves.toBe("Hello"))
